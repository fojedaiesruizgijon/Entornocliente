...
console.log("Array de objetos Persona ordenados alfabéticamente por el nombre");
console.log(porNombre.map(p => p.toString()));

// Orden por edad
const porEdad = [...personas].sort(Persona.cmpEdad);
console.log("Array de objetos Persona ordenados por la edad en orden creciente");
console.log(porEdad.map(p => p.toString()));

// Orden por altura
const porAltura = [...personas].sort(Persona.cmpAltura);
console.log("Array de objetos Persona ordenados por la altura en orden creciente");
